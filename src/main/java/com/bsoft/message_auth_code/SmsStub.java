...
public class SmsStub extends org.apache.axis2.client.Stub {
...

	{
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), sms0,
			...
			java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(), SmsResponse.class,
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(), SmsResponse.class,
							getEnvelopeNamespaces(resultEnv));
					callback.receiveResultSms((SmsResponse) object);
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(), ReplyResponse.class,
					getEnvelopeNamespaces(_returnEnv));
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(), ReplyResponse.class,
							getEnvelopeNamespaces(resultEnv));
					callback.receiveResultReply((ReplyResponse) object);
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(), ReportResponse.class,
					getEnvelopeNamespaces(_returnEnv));
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(), ReportResponse.class,
							getEnvelopeNamespaces(resultEnv));
					callback.receiveResultReport((ReportResponse) object);
	...
	public SearchSmsNumResponse SearchSmsNum(
			...
			SearchSmsNumRequest searchSmsNumRequest6)
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(), SearchSmsNumResponse.class,
					getEnvelopeNamespaces(_returnEnv));
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(), SearchSmsNumResponse.class,
							getEnvelopeNamespaces(resultEnv));
					callback.receiveResultSearchSmsNum((SearchSmsNumResponse) object);
	...
	public ReplyConfirmResponse ReplyConfirm(
			...
			ReplyConfirmRequest replyConfirmRequest8)
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(), ReplyConfirmResponse.class,
					getEnvelopeNamespaces(_returnEnv));
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(), ReplyConfirmResponse.class,
							getEnvelopeNamespaces(resultEnv));
					callback.receiveResultReplyConfirm((ReplyConfirmResponse) object);
	...
	public AuditingResponse Auditing(
			...
			AuditingRequest auditingRequest10)
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(), AuditingResponse.class,
					getEnvelopeNamespaces(_returnEnv));
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(), AuditingResponse.class,
							getEnvelopeNamespaces(resultEnv));
					callback.receiveResultAuditing((AuditingResponse) object);
	...
	public static class SearchSmsNumResponse implements org.apache.axis2.databinding.ADBBean {
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "SearchSmsNumResponse", "ns1");
		...
		public static class Factory {
			 ...
			 */
			public static SearchSmsNumResponse parse(javax.xml.stream.XMLStreamReader reader)
				...
				try {
					...
					if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.flaginfo.com.cn", "number")
							.equals(reader.getName())) {
	...
	public static class SearchSmsNumRequest implements org.apache.axis2.databinding.ADBBean {
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.flaginfo.com.cn", "SearchSmsNumRequest", "ns1");
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static SearchSmsNumRequest parse(javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
	...
	private org.apache.axiom.om.OMElement toOM(Sms param, boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(Sms.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
	...
	private org.apache.axiom.om.OMElement toOM(SmsResponse param, boolean optimizeContent)
		...
		try {
			return param.getOMElement(SmsResponse.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.om.OMElement toOM(ReplyRequest param, boolean optimizeContent)
		...
		try {
			return param.getOMElement(ReplyRequest.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.om.OMElement toOM(ReplyResponse param, boolean optimizeContent)
		...
		try {
			return param.getOMElement(ReplyResponse.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.om.OMElement toOM(Report param, boolean optimizeContent)
		...
		try {
			return param.getOMElement(Report.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.om.OMElement toOM(ReportResponse param, boolean optimizeContent)
		...
		try {
			return param.getOMElement(ReportResponse.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.om.OMElement toOM(AuditingRequest param, boolean optimizeContent)
		...
		try {
			return param.getOMElement(AuditingRequest.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.om.OMElement toOM(AuditingResponse param, boolean optimizeContent)
		...
		try {
			return param.getOMElement(AuditingResponse.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, Sms param,
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, ReplyRequest param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, Report param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			SearchSmsNumRequest param, boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			ReplyConfirmRequest param, boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			AuditingRequest param, boolean optimizeContent) throws org.apache.axis2.AxisFault {
